...
class BindingsServiceProvider extends BaseServiceProvider implements DeferrableProvider
{
    public function register()
    {
        ...
        $this->app->bind('InetStudio\Fns\Contracts\Drivers\BrandCashDriverContract', 'InetStudio\Fns\Drivers\BrandCashDriver');
        $this->app->bind('InetStudio\Fns\Contracts\Drivers\FnsDriverContract', 'InetStudio\Fns\Drivers\FnsDriver');
